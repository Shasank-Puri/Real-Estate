...
const SocialShare = ({ propertyId, propertyTitle, propertyType }) => {
    ...
    const fetchShareLinks = async () => {
        try {
            ...
            const response = await axios.get(
                `${process.env.REACT_APP_API_URL}/api/marketing/properties/${propertyId}/share`,
                {
            ...
            setError('Error generating share links');
